...
class CitiesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('actions', 'admin.cities.btn.btn')
            ->rawColumns([
                'actions',
                'checkbox',
            ]);
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'country.country_name_' . setting()->main_lang,
                'data'  => 'country.country_name_' . setting()->main_lang,
                'title' => __('admin.country_name_' . setting()->main_lang),
            ],
