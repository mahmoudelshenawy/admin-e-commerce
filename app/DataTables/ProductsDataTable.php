...
class ProductsDataTable extends DataTable
{
     ...
     */
    public static function query(Product $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text' => '<i class="fa fa-plus"></i> ' . trans('admin.create_product'), 'className' => 'btn btn-info', "action" => "function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'stock',
                'data'  => 'stock',
                'title' => __('admin.stock'),
            ],
            [
                'name'  => 'end_at',
                'data'  => 'end_at',
                'title' => __('admin.end_at'),
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
