...
class ManufacturerDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('actions', 'admin.manufacturers.btn.btn')
            ->rawColumns([
                'actions',
                'checkbox',
            ]);
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text' => '<i class="fa fa-plus"></i> ' . trans('admin.create_manufact'), 'className' => 'btn btn-info', "action" => "function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'title' => __('admin.contact_manager'),
            ],
            [
                'name'  => 'mobile',
                'data'  => 'mobile',
    ...
    {
        return 'Manufacturer' . date('YmdHis');
    }
}
