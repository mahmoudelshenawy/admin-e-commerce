...
class CategoriesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('actions', 'admin.categories.btn.btn')
            ->editColumn('parent_id', function ($units) {
                return $units->parent != NULL ? $units->parent->name_ . session('lang') : '';
            })
            ->rawColumns([
                'actions',
                'checkbox',
    ...
    {
        return Category::Query()->with('parent')->select('categories.*');
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text' => '<i class="fa fa-plus"></i> ' . trans('admin.create_category'), 'className' => 'btn btn-info', "action" => "function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            // [
            //     'name'  => 'parent_id',
            //     'data'  => 'parent.name_' . session('lang') == '' ? '' : 'parent.name_' . session('lang'),
            //     'title' => __('admin.parent_cat'),
            // ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
