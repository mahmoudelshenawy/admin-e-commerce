...
class ShippingsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('actions', 'admin.shippings.btn.btn')
            ->rawColumns([
                'actions',
                'checkbox',
            ]);
    ...
    public function query(Shipping $model)
    {
        ...
        return Shipping::Query()->with('user');
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text' => '<i class="fa fa-plus"></i> ' . trans('admin.create_shipping'), 'className' => 'btn btn-info', "action" => "function(){
