(function($) {
    ...
    $(window).on("resize", function() {
        if ($(window).width() < 992) {
            ...
            $(
                ".horizontal-menu .sidebar .slimScrollBar,.horizontal-menu .sidebar .slimScrollRail"
            ).remove();
            $(".horizontal-menu .sidebar .slimScrollDiv")
                .contents()
                .unwrap();
    ...
    $(".color-box").on("click", function() {
        ...
        $.session.set("$.session.set", $("input.color").val());
    });
    $("input.color").on("change", function() {
        ...
        var el = $(this).val();
        sessionStorage.setItem("sessionPrimaryColor", $(this).val());
    });

    var cookiesprimarycolor = getCookie("cookiesprimarycolor");
    var sessionPrimaryColor = sessionStorage.getItem("sessionPrimaryColor");
    if (sessionPrimaryColor != null && sessionPrimaryColor != "") {
        $("input.color").val(sessionPrimaryColor);
        $("body").css("--primarycolor", sessionPrimaryColor);
        $(".dark").css("--primarycolor", sessionPrimaryColor);
        $(".semi-dark").css("--primarycolor", sessionPrimaryColor);
        $(".semi-dark-alt").css("--primarycolor", sessionPrimaryColor);
    }
...
function createCookie(name, value) {
    ...
    document.cookie =
        name + "=" + value + ";expires=" + now.toUTCString() + "; path=/pollo";
}
...
function delete_cookie(name) {
    document.cookie =
        name + "=; Path=/pollo; Expires=Thu, 01 Jan 1970 00:00:01 GMT;";
}
