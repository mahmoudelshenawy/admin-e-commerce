            ...
            gmapContext.geodecoder.geocode(
                ...
                function(results, status) {
                    if (
                        ...
                        gmapContext.addressComponents = GmUtility.address_component_from_google_geocode(
    ...
    $.fn.locationpicker = function(options, params) {
        if (typeof options == "string") {
            ...
            switch (options) {
                case "location":
                    if (params == undefined) {
                        var location = GmUtility.locationFromLatLng(
                            gmapContext.location
                        );
        ...
        return this.each(function() {
            ...
            function displayMarkerWithSelectedArea() {
                GmUtility.setPosition(
                    ...
                    function(context) {
                        ...
                        context.settings.onchanged.apply(
                            gmapContext.domContainer,
                            [currentLocation, context.radius, true]
                        );
                    }
                );
            }
            ...
            google.maps.event.addListener(gmapContext.marker, "drag", function(
                event
            ) {
                updateInputValues(
                    gmapContext.settings.inputBinding,
