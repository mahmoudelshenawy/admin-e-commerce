...
(function(factory) {
    ...
    $.extend(Buttons.prototype, {
         ...
         */ text: function(node, label) {
            ...
            var linerTag =
                button.inCollection && buttonLiner && buttonLiner.tag
                    ? buttonLiner.tag
        ...
        _constructor: function() {
            ...
            $("body").on("keyup." + this.s.namespace, function(e) {
                if (
                    ...
                    if (
                        that.s.listenKeys.toLowerCase().indexOf(character) !==
                        -1
                    ) {
        ...
        _buildButton: function(config, inCollection) {
            ...
            var button = $("<" + tag + "/>")
                ...
                .on("keyup.dtb", function(e) {
                    if (e.keyCode === 13) {
                        if (
                            !button.hasClass(buttonDom.disabled) &&
                            config.action
                        ) {
                            action(e, dt, button, config);
                        }
        ...
        _popover: function(content, hostButton, inOpts) {
            ...
            display.insertAfter(hostNode).fadeIn(options.fade);
            ...
            if (position === "absolute") {
                ...
                if (
                    (bottomOverflow > topOverflow || options.dropup) &&
                    -moveTop < tableTop
                ) {
    ...
    var _exportData = function(dt, inOpts) {
        ...
        if (
            ...
            if (
                dt
                    .rows(config.rows, $.extend({ selected: true }, modifier))
                    .any()
            ) {
