...
<div class="col-12">
    <div class="card">
        ...
        <h4 class="card-title">{{ trans('admin.create_manufact') }}</h4>                                
        </div>
                    ...
                    <div class="col-12">
                        <form action="{{ route('manufacturers.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <label for="email1">{{trans('admin.mobile')}}</label>                                                   
                                ...
                                name="mobile" placeholder="{{trans('admin.mobile')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="website">{{trans('admin.website')}}</label>                  
                                        ...
                                        name="website" placeholder="{{trans('admin.website')}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">{{trans('admin.address')}}</label>                  
                                            <input type="text" class="form-control" id="address" 
                                    name="address" placeholder="{{trans('admin.address')}}" value="{{old('address')}}">
                                        </div>
                            ...
                            <div class="form-group">                                                  
                            <button type="submit" class="btn btn-primary">{{ trans('admin.create_manufact') }}</button></button>
                            </div>
                        </form>
                    </div>
                </div>
