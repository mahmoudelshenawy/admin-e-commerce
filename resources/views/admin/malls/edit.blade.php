...
<div class="col-12">
    <div class="card">
        ...
        <h4 class="card-title">{{ trans('admin.edit_mall') }}</h4>                                
        </div>
                    ...
                    <div class="col-12">
                        <form action="{{ route('malls.update' , $mall->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <label for="username1">{{trans('admin.name_ar')}}</label>                                                  
                                <input type="text" class="form-control" id="username1" name="name_ar" placeholder="{{trans('admin.name_ar')}}" value="{{$mall->name_ar}}">                                                    
                            </div>
                            <div class="form-group">
                                <label for="username2">{{trans('admin.name_en')}}</label>                                                  
                            <input type="text" class="form-control" id="username2" name="name_en" placeholder="{{trans('admin.name_en')}}" value="{{$mall->name_en}}">                                                    
                                </div>
                            <div class="form-group">
                            <label for="email1">{{trans('admin.mobile')}}</label>                                                   
                                <input type="text" class="form-control" id="email1" 
                                name="mobile" placeholder="{{trans('admin.mobile')}}" value="{{$mall->mobile}}">
                            </div>
                            <div class="form-group">
                                <label for="country">{{trans('admin.country')}}</label>                                                   
                                  ...
                                  <option value="{{$country->id}}" {{$mall->country_id == $country->id ? 'selected' : ''}} >{{session('lang') == 'ar' ?$country->country_name_ar : $country->country_name_en}}</option>
                                      @endforeach
                                  </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="code">{{trans('admin.email')}}</label>                                                   
                                    ...
                                    name="email" placeholder="{{trans('admin.email')}}" value="{{$mall->email}}">
                                </div>
                                <div class="form-group">
                                    <label for="website">{{trans('admin.website')}}</label>                  
                                        <input type="text" class="form-control" id="website" 
                                        name="website" placeholder="{{trans('admin.website')}}" value="{{$mall->website}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">{{trans('admin.address')}}</label>                  
                                            <input type="text" class="form-control" id="address" 
                                    name="address" placeholder="{{trans('admin.address')}}" value="{{old('address')}}" value="{{$mall->address}}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="facebook">{{trans('admin.facebook')}}</label>                  
                                            ...
                                            name="facebook" placeholder="{{trans('admin.facebook')}}" value="{{$mall->facebook}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="twitter">{{trans('admin.twitter')}}</label>                  
                                                <input type="text" class="form-control" id="twitter" 
                                                name="twitter" placeholder="{{trans('admin.twitter')}}" value="{{$mall->twitter}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="contact_manager">{{trans('admin.contact_manager')}}</label>                  
                                                    <input type="text" class="form-control" id="contact_manager" 
                                                    name="contact_manager" placeholder="{{trans('admin.contact_manager')}}" value="{{$mall->contact_manager}}">
                                                </div>
                                <div class="col-12 col-sm-6 my-2">
                                    ...
                                    @if (!empty($mall->icon))
                                    <img src="{{Storage::url($mall->icon)}}" style="width: 70px ; height:70px" class="img-thumbnail mb-3"/>
                                        @endif
                                </div> 
                            <div class="form-group">                                                  
                            <button type="submit" class="btn btn-primary">{{ trans('admin.edit_mall') }}</button></button>
                            </div>
                        </form>
                    </div>
                </div>
