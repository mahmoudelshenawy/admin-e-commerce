<a href="{{aurl('states/'.$id.'/edit')}}" class="btn btn-info mr-3"><i class="fa fa-edit"></i></a> 
...
<div id="del_admin{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <form action="{{ aurl('states/'.$id) }}" method="POST">
        @csrf
        @method('delete')
        <div class="modal-body">
          <h4>{{ trans('admin.delete_this',['name'=>session('lang') == 'ar'?$state_name_ar:$state_name_en ]) }}</h4>
        </div>
