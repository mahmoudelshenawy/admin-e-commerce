{{-- <a href="{{aurl('purchases/'.$id.'/edit')}}" class="btn btn-info mr-3"><i class="fa fa-edit"></i></a>  --}}
<a href="{{route('purchases.edit' , $id)}}" class="btn btn-info mr-3"><i class="fa fa-edit"></i></a> 
...
<div id="del_admin{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <form action="{{ aurl('purchases/'.$id) }}" method="POST">
        @csrf
        @method('delete')
